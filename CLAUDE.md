...
```text
Find the newest incomplete topic under topics/. Follow CLAUDE.md, STYLE.md, CHECKS.md, LOOPS.md, and the topic brief. Generate or revise local output files only. Run blog-agent check. Report completed files, warnings, and next human review actions. Do not publish, post, email, update a CMS, or invent citations.
```
